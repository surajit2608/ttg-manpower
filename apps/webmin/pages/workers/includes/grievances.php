<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12">
    <div class="d-flex justify-content-space-between align-items-center mb-1">
      ...
      <div>
        <a class="btn primary small round-0_25" on-click="modal.open" target="add-grievance-modal">
...
<script type="text/javascript">
  $Event.on('page.init', () => {
    if ($Data.get('tab') == 'grievances') {
      ...
      $Data.set('$url', '<%ADMIN_URL%>/api/applications/grievances/get')
  ...
  $Event.on('onLoadGrievances', () => {
    ...
    $Api.get('<%ADMIN_URL%>/api/applications/grievances/get').params(params).send()
  })
