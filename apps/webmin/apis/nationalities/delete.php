...
$rules = [
  'nationality.id' => 'required',
  'change_log.comment' => 'required',
];

$messages = [
  'nationality.id:required' => 'No nationality found',
...
Nationality::where('id', $id)->update(['deleted_at' => date('Y-m-d H:i:s')]);
...
$events = [
  'page.init' => true,
  'modal.close' => 'delete-nationality-modal',
  'message.show' => [
    'type' => 'success',
    'text' => 'Nationality successfully deleted',
  ],
];
