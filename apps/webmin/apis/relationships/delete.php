...
$messages = [
  'relationship.id:required' => 'No relationship found',
...
Relationship::where('id', $id)->update(['deleted_at' => date('Y-m-d H:i:s')]);
...
$events = [
  'page.init' => true,
  'modal.close' => 'delete-relationship-modal',
  'message.show' => [
    'type' => 'success',
    'text' => 'Relationship successfully deleted',
  ],
];
